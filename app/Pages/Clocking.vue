<template>
  <div>
    ...
    <!-- Clockings Table -->
    <table id="table" class="m-auto divide-y divide-gray-200 text-sm mt-2 text-center">
...
import LoadClocking from '~/components/loadClocking.vue'
...
const reloadClockings = async () => {
  const res = await $fetch('/yingerman/clockings/load', {
