  ...
  */
  ...
  function FormatDateH(cDate) {
    ...
    var yDayN = FormatDayOfMonth(aDate[1]);
    var yYear = FormatYear(aDate[2]);
   let yDate = yDayN += " " +  cFormatDate + ", " + yYear
    return yDate;
  }
  ...
  export function H2G(nYearH, nMonthH, nDateH) {
    nYearH  = Number(nYearH)
    nMonthH = Number(nMonthH)
    nDateH  = Number(nDateH)
    //return FormatDateH(nMonthH + "/" + nDateH + "/" + nYearH) + " -> "
    return HebToGreg(nYearH, nMonthH, nDateH)
    //document.write("<p>")
  }

  export function G2H(nYearG, nMonthG, nDateG) {
    ...
    return FormatDateH(GregToHeb(dGreg))
  }

  export function G2Hnumber(nYearG, nMonthG, nDateG) {
  ...
  export function getDayOfWeek(date) {
    ...
    return isNaN(dayOfWeek) ? null : 
      ['זונטאג', 'מאנטאג', 'דינסטאג', 'מיטוואך', 'דאנערשטאג', 'פרייטאג', 'שבת'][dayOfWeek];
  }
